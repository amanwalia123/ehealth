...
extern EIF_TYPED_VALUE F978_9009(EIF_REFERENCE);
...
EIF_TYPED_VALUE F978_9009 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 977, Current, 0, 0, 14659);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(977, Current, 14659);
	RTIV(Current, RTAL);
	RTHOOK(1);

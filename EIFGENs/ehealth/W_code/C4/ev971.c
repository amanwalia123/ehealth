...
extern EIF_TYPED_VALUE F971_8990(EIF_REFERENCE);
...
EIF_TYPED_VALUE F971_8990 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 970, Current, 1, 0, 14647);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6883, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(3);
	...
	RTCOMS(tr3,8989,0,"expose-event",12,1736732276);
	ur1 = tr3;
	...
	RTAR(tr3,tr4);
	tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6881, dtype))(Current)).it_p);

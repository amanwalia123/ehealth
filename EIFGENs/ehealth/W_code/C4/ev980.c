...
extern EIF_TYPED_VALUE F980_9019(EIF_REFERENCE);
extern EIF_TYPED_VALUE F980_9020(EIF_REFERENCE);
extern EIF_TYPED_VALUE F980_9021(EIF_REFERENCE);
...
EIF_TYPED_VALUE F980_9019 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 14667);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(979, Current, 14667);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F980_9020 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 14668);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(979, Current, 14668);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F980_9021 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 979, Current, 0, 0, 14666);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(979, Current, 14666);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000458, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1112, 0x01).id);

...
extern EIF_TYPED_VALUE F986_9045(EIF_REFERENCE);
...
RTOID (F986_9045)
EIF_TYPED_VALUE F986_9045 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14675);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(985, Current, 14675);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

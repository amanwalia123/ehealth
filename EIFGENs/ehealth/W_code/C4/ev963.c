...
extern EIF_TYPED_VALUE F963_8957(EIF_REFERENCE);
extern EIF_TYPED_VALUE F963_8958(EIF_REFERENCE);
...
EIF_TYPED_VALUE F963_8957 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 14622);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(962, Current, 14622);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F963_8958 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 962, Current, 0, 0, 14623);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(962, Current, 14623);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000459, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1113, 0x01).id);

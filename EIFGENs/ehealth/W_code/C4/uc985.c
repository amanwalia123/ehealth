...
extern EIF_TYPED_VALUE F985_9044(EIF_REFERENCE);
...
RTOID (F985_9044)
EIF_TYPED_VALUE F985_9044 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 984, Current, 0, 0, 14674);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(984, Current, 14674);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

...
static const EIF_TYPE_INDEX egt_13_963 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_14_963 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_15_963 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_16_963 [] = {0xFF01,1113,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_GENERIC(egt_13_963), 14618, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_963), 14622, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08B3 /*1113*/), 14619, 0},
	{EIF_GENERIC(egt_15_963), 14620, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_963), 14623, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08B3 /*1113*/), 14621, 8},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 989, 962);
}

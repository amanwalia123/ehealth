...
extern EIF_TYPED_VALUE F967_8981(EIF_REFERENCE);
extern EIF_TYPED_VALUE F967_8982(EIF_REFERENCE);
...
EIF_TYPED_VALUE F967_8981 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 966, Current, 0, 0, 14640);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(966, Current, 14640);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F967_8982 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 966, Current, 0, 0, 14641);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(966, Current, 14641);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000459, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1113, 0x01).id);

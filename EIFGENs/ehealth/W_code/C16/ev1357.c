...
extern EIF_TYPED_VALUE F1357_13663(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1357_13678_body(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1357_13663 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1356, Current, 6, 0, 19714);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1356, Current, 19714);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10521, dtype))(Current)).it_i4);
	RTHOOK(4);
	tb1 = '\0';
	...
	if (tb1) {
		...
		if (!tb2) {
			...
			if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 1L))) {
				...
				tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7083, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
				tb2 = RTCEQ(tr1, tr2);
			}
			tb1 = tb2;
		}
		if (tb1) {
			RTHOOK(6);
			RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
			Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10440, dtype))(Current)).it_i4);
			...
			if ((EIF_BOOLEAN) (loc2 < ti4_1)) {
				...
				loc4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10514, dtype))(Current)).it_i4);
				for (;;) {
					RTHOOK(11);
					...
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (loc2 >= loc4) && (EIF_BOOLEAN) (loc2 <= loc3))) {
						...
						loc6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10515, dtype))(Current)).it_i4);
...
/* {EV_BOX_I}.interface */
static EIF_TYPED_VALUE F1357_13678_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1356, Current, 0, 0, 19715);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1356, Current, 19715);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1357_13678 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9481, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1357_13678_body (Current)).it_r;

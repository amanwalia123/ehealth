...
extern EIF_TYPED_VALUE F1422_14770(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1422_14771(EIF_REFERENCE);
extern void F1422_14772(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1422_14773(EIF_REFERENCE);
static EIF_TYPED_VALUE F1422_14774_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1422_14774(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1422_14770 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1421, Current, 0, 0, 20625);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1421, Current, 20625);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1422_14771 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1422_14772 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1421, Current, 0, 1, 20627);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1421, Current, 20627);
	RTCC(arg1, 1421, l_feature_name, 1, RTWCT(9481, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1422_14773 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1421, Current, 0, 0, 20628);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1421, Current, 20628);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5684, 868))(Current)).it_p);
	up1 = tp1;
...
static EIF_TYPED_VALUE F1422_14774_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1421, Current, 0, 0, 20629);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1421, Current, 20629);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1422_14774 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9481, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1422_14774_body (Current)).it_r;

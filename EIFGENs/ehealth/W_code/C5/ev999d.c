...
static const EIF_TYPE_INDEX egt_13_999 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_14_999 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_15_999 [] = {0xFF01,1298,0xFFFF};
...
static const struct desc_info desc_999[] = {
	...
	{EIF_GENERIC(egt_13_999), 14753, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_999), 14755, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08B3 /*1113*/), 14754, 0},
...
void Init999(void)
{
	...
	IDSC(desc_999 + 32, 710, 998);
	IDSC(desc_999 + 35, 714, 998);
}

...
static const EIF_TYPE_INDEX egt_13_1001 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1001 [] = {0xFF01,1113,0xFFFF};
...
static const struct desc_info desc_1001[] = {
	...
	{EIF_GENERIC(egt_13_1001), 14756, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1001), 14758, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08B3 /*1113*/), 14757, 0},
};
void Init1001(void)
{
	IDSC(desc_1001, 0, 1000);
	IDSC(desc_1001 + 1, 1, 1000);
	IDSC(desc_1001 + 32, 705, 1000);
}

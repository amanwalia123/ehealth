...
static const EIF_TYPE_INDEX egt_13_1013 [] = {0xFF01,911,0xFFFF};
...
static const struct desc_info desc_1013[] = {
	...
	{EIF_GENERIC(egt_13_1013), 14878, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1013), 14879, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_15_1013), 14885, 0xFFFFFFFF},
};
void Init1013(void)
{
	IDSC(desc_1013, 0, 1012);
	IDSC(desc_1013 + 1, 1, 1012);
	IDSC(desc_1013 + 32, 549, 1012);
	IDSC(desc_1013 + 36, 471, 1012);
}

...
extern EIF_REFERENCE _A1170_324_3_4_5_6();
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 994, Current, 1, 0, 14700);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(9075,1);
	RTDBGEAA(994, Current, 14700);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6955, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTHOOK(3);
	...
	RTCOMS(tr3,9075,0,"expose-event",12,1736732276);
	ur1 = tr3;
	...
	RTAR(tr3,tr4);
	tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6953, dtype))(Current)).it_p);
	...
	*((EIF_INTEGER_32 *)tr5+3) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 6L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr6 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1170_324_3_4_5_6, (EIF_POINTER)(0),8438, tr4, 0, 1, -1, tr3, 4);
	}
	ur2 = RTCCL(tr6);
	...
	RTNHOOK(3,3);
	tr8 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8518, "expose_translate_agent", tr7))(tr7)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur3 = RTCCL(tr8);
	ub1 = (EIF_BOOLEAN) 0;

...
extern EIF_TYPED_VALUE F1086_10160(EIF_REFERENCE);
...
RTOID (F1086_10160)
EIF_TYPED_VALUE F1086_10160 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1085, Current, 0, 0, 15876);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1085, Current, 15876);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

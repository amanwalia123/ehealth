...
extern void F1059_9607(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {PILL}.make_pill */
void F1059_9607 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
	char *l_feature_name = "make_pill";
	RTEX;
...
#define ui8_1 ui8_1x.it_i8
	...
	RTEAA(l_feature_name, 1058, Current, 0, 4, 15155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1058, Current, 15155);
	RTCC(arg2, 1058, l_feature_name, 2, eif_new_type(220, 0x01), 0x01);
	RTCC(earg3, 1058, l_feature_name, 3, eif_new_type(1147, 0x00), 0x00);
	RTCC(earg4, 1058, l_feature_name, 4, eif_new_type(1147, 0x00), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ui8_1 = arg1;
	ur1 = RTCCL(arg2);

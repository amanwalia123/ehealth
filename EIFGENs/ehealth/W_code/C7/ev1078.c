...
extern EIF_TYPED_VALUE F1078_10007(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1078_10007 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1077, Current, 0, 0, 15546);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1077, Current, 15546);
	RTIV(Current, RTAL);

...
extern EIF_TYPED_VALUE F1077_10006(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1077_10006 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1076, Current, 0, 0, 15545);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1076, Current, 15545);
	RTIV(Current, RTAL);

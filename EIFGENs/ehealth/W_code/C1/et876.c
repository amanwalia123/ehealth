...
extern void F876_16479(EIF_REFERENCE, int);
extern void EIF_Minit876(void);
extern EIF_REFERENCE _A1061_35_2();
...
#define ui4_1 ui4_1x.it_i4
	...
	RTLXI(loc1);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6129, 0xF8000376, 0); /* model */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6129, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6134, 0xF80003B5, 0); /* sys */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6134, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6137, 0xF80003B3, 0); /* ui */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6137, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6135, 0xF8000413, 0); /* input */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6135, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(5);
	RTDBGAA(Current, dtype, 6136, 0xF8000424, 0); /* output */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6136, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	RTNHOOK(6,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7392, "model", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	RTNHOOK(6,2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6333, "reset", tr2))(tr2);
	RTHOOK(7);
	...
	RTNHOOK(7,2);
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFFF9,1,174,0xFF01,1060,0xFFFF};
		EIF_TYPE typres0;
	...
	*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr5 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1061_35_2, (EIF_POINTER)(0),7391, tr3, 0, 1, -1, tr1, 1);
	}
	ur1 = RTCCL(tr5);
		...
		*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		...
		if (tb1) {
			...
			*(EIF_BOOLEAN *)(Current + RTWA(6130, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
			...
			RTNHOOK(10,1);
			tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7387, "error_message", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr3);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(4438, Dtype(tr1)))(tr1, ur1x);
			RTNHOOK(10,2);
			RTAR(Current, tr1);
			*(EIF_REFERENCE *)(Current + RTWA(6131, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
			...
			RTNHOOK(13,1);
			ur1 = RTCCL(arg1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6784, "execute_without_log", tr1))(tr1, ur1x);
			RTHOOK(14);
			RTDBGAA(Current, dtype, 6130, 0x04000000, 1); /* error */
			*(EIF_BOOLEAN *)(Current + RTWA(6130, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
			RTHOOK(15);
			...
			*(EIF_REFERENCE *)(Current + RTWA(6131, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
			...
			tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6136, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(16,1);
			tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7393, "model_state", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr3);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(4438, Dtype(tr1)))(tr1, ur1x);
			RTNHOOK(16,2);
			RTAR(Current, tr1);
...
void F876_16479 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 875, Current, 0, 16478);
	RTSA(dtype);
	RTME(dtype, 0);

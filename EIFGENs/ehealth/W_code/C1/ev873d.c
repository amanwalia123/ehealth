...
static const EIF_TYPE_INDEX egt_13_873 [] = {0xFF01,226,0xFFFF};
...
static const struct desc_info desc_873[] = {
	...
	{EIF_NON_GENERIC(0x0921 /*1168*/), 13821, 0},
	{EIF_GENERIC(egt_13_873), 13822, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x09AB /*1237*/), 13823, 8},
	{EIF_GENERIC(NULL), 13824, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13825, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 13826, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01C5 /*226*/), 13827, 16},
};
void Init873(void)
{
	IDSC(desc_873, 0, 872);
	IDSC(desc_873 + 1, 1, 872);
	IDSC(desc_873 + 32, 534, 872);
}

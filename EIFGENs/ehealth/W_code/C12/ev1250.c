...
extern EIF_TYPED_VALUE F1250_12060(EIF_REFERENCE);
extern void F1250_12061(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1250_12060 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1250_12061 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1249, Current, 0, 0, 18402);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1249, Current, 18402);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8550, 0xF8000587, 0); /* implementation */

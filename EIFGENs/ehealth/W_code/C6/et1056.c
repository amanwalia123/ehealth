...
extern void F1056_9590(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1056_9591(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1056_9592(EIF_REFERENCE);
...
/* {ETF_TUPLE_ARG}.make */
void F1056_9590 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1055, Current, 0, 1, 15138);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 15138);
	{
	...
	*(EIF_REFERENCE *)(Current + RTWA(7346, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7370, 0xF8000123, 0); /* value */
	RTAR(Current, arg1);
...
/* {ETF_TUPLE_ARG}.value */
EIF_TYPED_VALUE F1056_9591 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {ETF_TUPLE_ARG}.out */
EIF_TYPED_VALUE F1056_9592 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1055, Current, 1, 0, 15140);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1055, Current, 15140);
	RTIV(Current, RTAL);
	RTHOOK(1);

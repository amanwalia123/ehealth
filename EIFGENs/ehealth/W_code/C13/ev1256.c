...
extern EIF_TYPED_VALUE F1256_12089(EIF_REFERENCE);
extern void F1256_12090(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1256_12089 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1256_12090 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1255, Current, 0, 0, 18430);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1255, Current, 18430);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8550, 0xF8000591, 0); /* implementation */

...
extern EIF_TYPED_VALUE F1459_15368(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1459_15368 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1458, Current, 0, 0, 21137);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1458, Current, 21137);
	RTIV(Current, RTAL);
	RTHOOK(1);

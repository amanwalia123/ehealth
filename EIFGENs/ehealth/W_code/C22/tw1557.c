...
extern EIF_TYPED_VALUE F1557_2908(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1557_2909(EIF_REFERENCE);
extern void F1557_2910(EIF_REFERENCE);
extern void F1557_2911(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1557_2912(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1557_2913(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1557_2908 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1556, Current, 1, 0, 15979);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1556, Current, 15979);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1557_2909 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1556, Current, 0, 0, 15980);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1556, Current, 15980);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1557_2910 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1556, Current, 2, 0, 15981);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1556, Current, 15981);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(2373, dtype)) = (EIF_INTEGER_32) ti4_1;
	...
	if (tb1) {
		RTHOOK(10);
		RTDBGAA(Current, dtype, 2391, 0xF8000617, 0); /* active */
...
void F1557_2911 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1556, Current, 3, 0, 15982);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1556, Current, 15982);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);
...
EIF_TYPED_VALUE F1557_2912 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1557_2913 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;

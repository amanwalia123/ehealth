/*
 * Code for class BI_LINKABLE [INTEGER_32]
 */
...
extern EIF_TYPED_VALUE F1579_1904(EIF_REFERENCE);
extern void F1579_1905(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1579_1906(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1579_1907(EIF_REFERENCE);
extern void F1579_1908(EIF_REFERENCE);
extern void F1579_1909(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1579_1910(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1579_1911(EIF_REFERENCE);
extern void F1579_1912(EIF_REFERENCE);
extern void F1579_6897(EIF_REFERENCE, int);
...
/* {BI_LINKABLE}.left */
EIF_TYPED_VALUE F1579_1904 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1579_1905 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1578, Current, 2, 1, 15703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 15703);
	RTCC(arg1, 1578, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1688, 0xF800062A, 0); /* right */
	RTAR(Current, arg1);
...
void F1579_1906 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1578, Current, 1, 1, 15704);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 15704);
	RTCC(arg1, 1578, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800062A, 0, 0); /* loc1 */
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1691, 0xF800062A, 0); /* left */
	RTAR(Current, arg1);
...
void F1579_1907 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1578, Current, 2, 0, 15705);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 15705);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F1579_1908 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1578, Current, 2, 0, 15706);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 15706);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F1579_1909 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1578, Current, 1, 1, 15707);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 15707);
	RTCC(arg1, 1578, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800062A, 0, 0); /* loc1 */
...
void F1579_1910 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1578, Current, 1, 1, 15708);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 15708);
	RTCC(arg1, 1578, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800062A, 0, 0); /* loc1 */
...
void F1579_1911 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1578, Current, 0, 0, 15709);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1578, Current, 15709);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 1688, 0xF800062A, 0); /* right */
...
void F1579_1912 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1578, Current, 0, 0, 15710);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1578, Current, 15710);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1691, 0xF800062A, 0); /* left */
	*(EIF_REFERENCE *)(Current + RTWA(1691, dtype)) = (EIF_REFERENCE) NULL;
...
void F1579_6897 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU(SK_REF, &loc1);
	RTLU(SK_REF, &loc2);
	RTEAINV(l_feature_name, 1578, Current, 2, 6896);
	RTSA(dtype);
	RTME(dtype, 0);

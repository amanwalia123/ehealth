...
extern EIF_TYPED_VALUE F1576_2908(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1576_2909(EIF_REFERENCE);
extern void F1576_2910(EIF_REFERENCE);
extern void F1576_2911(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1576_2908 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1575, Current, 1, 0, 15991);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 15991);
	RTIV(Current, RTAL);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1575, Current, 0, 0, 15992);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 15992);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1576_2910 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1575, Current, 2, 0, 15993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 15993);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(2373, dtype)) = (EIF_INTEGER_32) ti4_1;
	...
	if (tb1) {
		RTHOOK(10);
		RTDBGAA(Current, dtype, 2391, 0xF800062A, 0); /* active */
...
void F1576_2911 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1575, Current, 3, 0, 15994);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1575, Current, 15994);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("valid_position", EX_PRE);

...
extern EIF_TYPED_VALUE F1560_1904(EIF_REFERENCE);
extern void F1560_1905(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1560_1906(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1560_1907(EIF_REFERENCE);
extern void F1560_1908(EIF_REFERENCE);
extern void F1560_1909(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1560_1910(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1560_1911(EIF_REFERENCE);
extern void F1560_1912(EIF_REFERENCE);
extern void F1560_6897(EIF_REFERENCE, int);
...
/* {BI_LINKABLE}.left */
EIF_TYPED_VALUE F1560_1904 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1560_1905 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1559, Current, 2, 1, 15683);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1559, Current, 15683);
	RTCC(arg1, 1559, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1688, 0xF8000617, 0); /* right */
	RTAR(Current, arg1);
...
void F1560_1906 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1559, Current, 1, 1, 15684);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1559, Current, 15684);
	RTCC(arg1, 1559, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000617, 0, 0); /* loc1 */
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1691, 0xF8000617, 0); /* left */
	RTAR(Current, arg1);
...
void F1560_1907 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1559, Current, 2, 0, 15685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1559, Current, 15685);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F1560_1908 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1559, Current, 2, 0, 15686);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1559, Current, 15686);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F1560_1909 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1559, Current, 1, 1, 15687);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1559, Current, 15687);
	RTCC(arg1, 1559, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000617, 0, 0); /* loc1 */
...
void F1560_1910 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1559, Current, 1, 1, 15688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1559, Current, 15688);
	RTCC(arg1, 1559, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000617, 0, 0); /* loc1 */
...
void F1560_1911 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1559, Current, 0, 0, 15689);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1559, Current, 15689);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 1688, 0xF8000617, 0); /* right */
...
void F1560_1912 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1559, Current, 0, 0, 15690);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1559, Current, 15690);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1691, 0xF8000617, 0); /* left */
	*(EIF_REFERENCE *)(Current + RTWA(1691, dtype)) = (EIF_REFERENCE) NULL;
...
void F1560_6897 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU(SK_REF, &loc1);
	RTLU(SK_REF, &loc2);
	RTEAINV(l_feature_name, 1559, Current, 2, 6896);
	RTSA(dtype);
	RTME(dtype, 0);

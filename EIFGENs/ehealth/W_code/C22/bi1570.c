/*
 * Code for class BI_LINKABLE [INTEGER_64]
 */
...
extern EIF_TYPED_VALUE F1570_1904(EIF_REFERENCE);
extern void F1570_1905(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1570_1906(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1570_1907(EIF_REFERENCE);
extern void F1570_1908(EIF_REFERENCE);
extern void F1570_1909(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1570_1910(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1570_1911(EIF_REFERENCE);
extern void F1570_1912(EIF_REFERENCE);
extern void F1570_6897(EIF_REFERENCE, int);
...
/* {BI_LINKABLE}.left */
EIF_TYPED_VALUE F1570_1904 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1570_1905 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1569, Current, 2, 1, 15693);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1569, Current, 15693);
	RTCC(arg1, 1569, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1688, 0xF8000621, 0); /* right */
	RTAR(Current, arg1);
...
void F1570_1906 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1569, Current, 1, 1, 15694);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1569, Current, 15694);
	RTCC(arg1, 1569, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000621, 0, 0); /* loc1 */
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1691, 0xF8000621, 0); /* left */
	RTAR(Current, arg1);
...
void F1570_1907 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1569, Current, 2, 0, 15695);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1569, Current, 15695);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F1570_1908 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1569, Current, 2, 0, 15696);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1569, Current, 15696);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F1570_1909 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1569, Current, 1, 1, 15697);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1569, Current, 15697);
	RTCC(arg1, 1569, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000621, 0, 0); /* loc1 */
...
void F1570_1910 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1569, Current, 1, 1, 15698);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1569, Current, 15698);
	RTCC(arg1, 1569, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF8000621, 0, 0); /* loc1 */
...
void F1570_1911 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1569, Current, 0, 0, 15699);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1569, Current, 15699);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 1688, 0xF8000621, 0); /* right */
...
void F1570_1912 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1569, Current, 0, 0, 15700);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1569, Current, 15700);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1691, 0xF8000621, 0); /* left */
	*(EIF_REFERENCE *)(Current + RTWA(1691, dtype)) = (EIF_REFERENCE) NULL;
...
void F1570_6897 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU(SK_REF, &loc1);
	RTLU(SK_REF, &loc2);
	RTEAINV(l_feature_name, 1569, Current, 2, 6896);
	RTSA(dtype);
	RTME(dtype, 0);

...
extern EIF_TYPED_VALUE F1333_13318(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1333_13318 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1332, Current, 0, 0, 19438);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1332, Current, 19438);
	RTIV(Current, RTAL);
	RTHOOK(1);

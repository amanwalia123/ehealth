...
extern void F1344_13400(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1344_13401(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1344_13402(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1344_13403(EIF_REFERENCE);
extern void F1344_13404(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1344_13405_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1344_13405(EIF_REFERENCE);
extern void EIF_Minit1344(void);
extern EIF_REFERENCE _A1170_335();
extern EIF_REFERENCE _A1170_334();
...
void F1344_13400 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1343, Current, 0, 1, 19498);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1343, Current, 19498);
	RTCC(arg1, 1343, l_feature_name, 1, RTWCT(9481, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
...
void F1344_13401 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1343, Current, 3, 0, 19499);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1343, Current, 19499);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up2 = tp2;
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5713, 868))(Current)).it_i4);
	ui4_1 = ti4_1;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1170_334, (EIF_POINTER)(0),8448, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1170_335, (EIF_POINTER)(0),8449, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10003, dtype))(Current, up1x, ur1x, ur2x, ur3x);
...
EIF_TYPED_VALUE F1344_13402 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1343, Current, 2, 0, 19500);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1343, Current, 19500);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
...
EIF_TYPED_VALUE F1344_13403 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1344_13404 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1343, Current, 1, 1, 19502);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1343, Current, 19502);
	RTCC(arg1, 1343, l_feature_name, 1, eif_new_type(173, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10328, 0xF80000AD, 0); /* start_path */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(10328, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
...
static EIF_TYPED_VALUE F1344_13405_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1343, Current, 0, 0, 19503);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1343, Current, 19503);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1344_13405 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9481, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1344_13405_body (Current)).it_r;

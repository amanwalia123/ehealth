...
extern void F1135_10548(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1135_10548 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui8_2 ui8_2x.it_i8
	...
	RTEAA(l_feature_name, 1134, Current, 0, 2, 16728);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1134, Current, 16728);
	{
		...
		RTCC(arg2, 1134, l_feature_name, 2, typres0, 0x01);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ui8_1 = arg1;
		ur1 = RTCCL(arg2);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(8168, dtype))(Current, ui8_1x, ur1x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
...
body:;
	...
	ur1 = RTCCL(tr2);
	ti8_1 = eif_integer_64_item(RTCV(arg2),2);
	ui8_2 = ti8_1;
	tr3 = eif_boxed_item(arg2,3);
	ur2 = RTRCL(tr3);
	tr4 = eif_boxed_item(arg2,4);
	ur3 = RTRCL(tr4);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6336, "add_medication", tr1))(tr1, ui8_1x, ur1x, ui8_2x, ur2x, ur3x);
	RTHOOK(4);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8162, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);

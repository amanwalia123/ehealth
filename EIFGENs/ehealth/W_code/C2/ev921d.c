...
static const EIF_TYPE_INDEX egt_13_921 [] = {0xFF01,980,0xFFFF};
static const EIF_TYPE_INDEX egt_14_921 [] = {0xFF01,1113,0xFFFF};
...
static const struct desc_info desc_921[] = {
	...
	{EIF_GENERIC(egt_13_921), 14335, 0},
	{EIF_GENERIC(egt_14_921), 14336, 0xFFFFFFFF},
};
void Init921(void)
{
	IDSC(desc_921, 0, 920);
	IDSC(desc_921 + 1, 1, 920);
	IDSC(desc_921 + 32, 708, 920);
}

...
extern EIF_TYPED_VALUE F910_8572(EIF_REFERENCE);
...
RTOID (F910_8572)
EIF_TYPED_VALUE F910_8572 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 909, Current, 0, 0, 14278);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(909, Current, 14278);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

...
extern EIF_TYPED_VALUE F905_8489(EIF_REFERENCE);
...
RTOID (F905_8489)
EIF_TYPED_VALUE F905_8489 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 904, Current, 0, 0, 14213);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(904, Current, 14213);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

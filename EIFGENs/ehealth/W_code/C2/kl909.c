...
extern EIF_TYPED_VALUE F909_8571(EIF_REFERENCE);
...
RTOID (F909_8571)
EIF_TYPED_VALUE F909_8571 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 908, Current, 0, 0, 14277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(908, Current, 14277);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

...
static const EIF_TYPE_INDEX egt_13_900 [] = {0xFF01,971,0xFFFF};
static const EIF_TYPE_INDEX egt_14_900 [] = {0xFF01,1113,0xFFFF};
...
static const struct desc_info desc_900[] = {
	...
	{EIF_GENERIC(egt_13_900), 14187, 0},
	{EIF_GENERIC(egt_14_900), 14188, 0xFFFFFFFF},
};
void Init900(void)
{
	IDSC(desc_900, 0, 899);
	IDSC(desc_900 + 1, 1, 899);
	IDSC(desc_900 + 32, 930, 899);
}

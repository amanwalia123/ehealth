...
extern EIF_TYPED_VALUE F923_8642(EIF_REFERENCE);
...
RTOID (F923_8642)
EIF_TYPED_VALUE F923_8642 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 922, Current, 0, 0, 14337);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(922, Current, 14337);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);

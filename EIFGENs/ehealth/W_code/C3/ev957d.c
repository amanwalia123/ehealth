...
static const EIF_TYPE_INDEX egt_13_957 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_14_957 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_15_957 [] = {0xFF01,1113,0xFFFF};
static const EIF_TYPE_INDEX egt_16_957 [] = {0xFF01,1113,0xFFFF};
...
static const struct desc_info desc_957[] = {
	...
	{EIF_GENERIC(egt_13_957), 14594, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_957), 14598, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08B3 /*1113*/), 14595, 0},
	{EIF_GENERIC(egt_15_957), 14596, 0xFFFFFFFF},
	{EIF_GENERIC(egt_16_957), 14599, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08B3 /*1113*/), 14597, 8},
};
void Init957(void)
{
	IDSC(desc_957, 0, 956);
	IDSC(desc_957 + 1, 1, 956);
	IDSC(desc_957 + 32, 999, 956);
}

...
extern EIF_TYPED_VALUE F930_8724(EIF_REFERENCE);
extern EIF_TYPED_VALUE F930_8725(EIF_REFERENCE);
...
EIF_TYPED_VALUE F930_8724 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F930_8725 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 929, Current, 0, 0, 14425);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(929, Current, 14425);
	RTIV(Current, RTAL);
	RTHOOK(1);

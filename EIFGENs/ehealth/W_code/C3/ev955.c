...
extern EIF_TYPED_VALUE F955_8917(EIF_REFERENCE);
extern EIF_TYPED_VALUE F955_8918(EIF_REFERENCE);
...
EIF_TYPED_VALUE F955_8917 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 954, Current, 0, 0, 14592);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(954, Current, 14592);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F955_8918 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 954, Current, 0, 0, 14593);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(954, Current, 14593);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000459, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1113, 0x01).id);

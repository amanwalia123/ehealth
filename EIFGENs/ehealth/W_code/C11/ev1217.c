...
extern EIF_TYPED_VALUE F1217_11652(EIF_REFERENCE);
extern void F1217_11653(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1217_11652 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1217_11653 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1216, Current, 0, 0, 17993);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1216, Current, 17993);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8550, 0xF800054D, 0); /* implementation */

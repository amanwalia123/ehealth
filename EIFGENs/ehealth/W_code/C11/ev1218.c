...
extern EIF_TYPED_VALUE F1218_11654(EIF_REFERENCE);
extern void F1218_11655(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1218_11654 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1218_11655 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1217, Current, 0, 0, 17995);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1217, Current, 17995);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8550, 0xF800054E, 0); /* implementation */
